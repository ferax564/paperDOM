...
| Format bar | Contextual top toolbar for the selection: font family/size, bold/italic/underline/strike, text color, alignment, fill/border, preset geometry, bring-to-front/send-to-back, group/ungroup | Supported; format-bar browser test. Multi-selection applies to every unlocked selected object |
